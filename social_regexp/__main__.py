...
from social_regexp import __version__
from social_regexp.example import hello
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]social-regexp[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the social-regexp package.",
    ),
):
